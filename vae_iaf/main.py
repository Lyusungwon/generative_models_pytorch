...
parser.add_argument('--flow-hidden-size', type=int, default=100, metavar='N')
parser.add_argument('--latent-size', type=int, default=10, metavar='N')
parser.add_argument('--layer-num', type=int, default=5, metavar='N')
parser.add_argument('--T', type=int, default=5, metavar='N')
parser.add_argument('--h', type=int, default=5, metavar='N')
